...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/template/builder/nats/templateui/test/integration/FirstJourney",
    "com/template/builder/nats/templateui/test/integration/TemplateMasterListJourney",
    "com/template/builder/nats/templateui/test/integration/TemplateMasterObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
